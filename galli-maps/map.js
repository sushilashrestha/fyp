...
const recommendations = [
    { id: 1, name: "Bhaktapur Durbar Square", latitude: 27.6722, longitude: 85.4285, description: "A historic royal palace complex with courtyards, temples, and statues."},
    { id: 2, name: "Nyatapola Temple", latitude: 27.6710, longitude: 85.4308, description: "A five-story pagoda temple known for its impressive architecture" },
    { id: 3, name: "Taumadhi Square", latitude: 27.6705, longitude: 85.4306, description: "A vibrant square featuring the Nyatapola Temple and other historical structures." },
    { id: 4, name: "Dattatreya Temple", latitude: 27.6743, longitude: 85.4321, description: "A unique three-roofed temple dedicated to the Hindu trinity."},
    { id: 5, name: "55 Window Palace", latitude: 27.6722, longitude: 85.4289, description: "An intricately carved palace with 55 windows and historical significance."}
];
...
function displayRecommendationList() {
    ...
    recommendations.forEach(rec => {
        listHTML += `<li onclick="showRecommendationDetails(${rec.id})">${rec.name}</li>`;
    });
    listHTML += '</ul>';
